    ...
    return (
        <div className="animate-fade-in-up">
            ...
            <button
                ...
                className="w-full py-3.5 rounded-xl border-2 border-deep-marine-200 bg-white text-deep-marine-700 font-semibold hover:bg-deep-marine-50 hover:border-deep-marine-300 transition-all flex items-center justify-center gap-3 shadow-sm"
            >
            ...
            <form onSubmit={handleLogin} className="space-y-5">
                <div>
                    ...
                    <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl bg-white border border-deep-marine-200 text-deep-marine-800 placeholder-caribbean-aqua300 focus:outline-none focus:ring-2 focus:ring-ocean-teal500 focus:border-transparent transition-all"
            ...
            <p className="text-center text-caribbean-aqua text-sm mt-8">
                {t('noAccount')}{' '}
                <a href="/registro" className="text-ocean-teal-600 hover:text-ocean-teal-500 font-semibold">
                    {t('registerButton')}
                </a>
            </p>
        </div>
