    ...
    if (success) {
        return (
            <BlurFade delay={0.1} duration={0.5}>
                <div className="relative rounded-2xl bg-white p-8 shadow-card overflow-hidden text-center">
                    <ShineBorder shineColor={['#2A9D8F', '#E9C46A']} duration={8} />

                    <div className="w-16 h-16 bg-ocean-teal/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <BlurFade delay={0.1} duration={0.5}>
            <div className="relative rounded-2xl bg-white p-8 shadow-card overflow-hidden">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg className="w-4 h-4 text-caribbean-aqua/50" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                ...
                                <input
                                    ...
                                    required
                                    minLength={6}
                                    className="w-full pl-10 pr-3 py-3.5 rounded-xl bg-salt-white border border-deep-marine-100 text-deep-marine-800 placeholder-caribbean-aqua/40 focus:outline-none focus:ring-2 focus:ring-ocean-teal/40 focus:border-ocean-teal/30 transition-all"
                                    placeholder="••••••"
                                />
                            </div>
                        </div>
                ...
                <p className="text-center text-caribbean-aqua text-sm mt-8">
                    {t('hasAccount')}{' '}
                    <a href="/login" className="text-ocean-teal hover:text-ocean-teal-600 font-semibold transition-colors">
                        {t('loginButton')}
                    </a>
                </p>
            </div>
