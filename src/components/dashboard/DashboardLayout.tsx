                    ...
                    {user.role === 'admin' && (
                        <>
                            <div className="pt-4 pb-2 px-4">
                                <span className="text-[10px] font-semibold uppercase tracking-widest text-caribbean-aqua/30">Admin</span>
                            </div>
                            {adminItems.map((item) => {
                                const active = isActive(item.href);
                                return (
                                    <Link
                                        ...
                                        href={`/${locale}${item.href}`}
                                        className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${active
                                                ? 'bg-sand-gold/10 text-sand-gold shadow-sm shadow-sand-gold/5'
                                                : 'text-caribbean-aqua/60 hover:text-salt-white hover:bg-white/5'
                                            }`}
                                    >
                                        {item.icon}
