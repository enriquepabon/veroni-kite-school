...
export default function WhatsAppWidget() {
    ...
    const message = encodeURIComponent('Hola! Me interesa aprender kitesurf con Veroni Kite. ¿Pueden darme más información?');
    ...
    return (
        ...
        >
            {/* Ping animation */}
            <span className="absolute w-full h-full rounded-full bg-[#25D366] animate-ping opacity-20 group-hover:opacity-0" />
