                        ...
                        {status === 'success' ? (
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                                <input
                                    ...
                                    placeholder={t('name')}
                                    className="flex-1 rounded-xl px-4 py-3 bg-white/90 text-night-tide placeholder:text-deep-marine-400 border-0 outline-none focus:ring-2 focus:ring-white/50 transition-shadow duration-300"
                                />
                                <input
                                    name="email"
                                    type="email"
